# Archived local and academic project guide

This is a historical guide, not the hosted application's operating instructions.
Use [the current README](README.md) for account-based storage, startup, deployment
and recovery. The local CSV described below is not a hosted user's workspace.
