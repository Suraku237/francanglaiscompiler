...
def lexical_spec() -> dict:
    return {
        ...
        "limitations": [
            ...
            "Explicit French forms supplement missing references, including the observed accentless ca/francais forms; uncertain n'ais and alli remain UNKNOWN.",
            ...
            "Code-mixing compares French/English/Pidgin language candidates from word lists and explicit reference labels, separately from parts of speech.",
            "Ambiguous language evidence is retained, UNKNOWN words are not assigned a language, and sentence-ending punctuation resets comparisons.",
            "Reference origins, borrowings and morphological guesses are evidence, not proof of a speaker's language; unlabelled local-language words remain unresolved.",
